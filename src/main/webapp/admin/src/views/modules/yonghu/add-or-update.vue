        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="政治面貌" prop="zhengzimianmaoTypes">
                        <el-select v-model="ruleForm.zhengzimianmaoTypes" :disabled="ro.zhengzimianmaoTypes" placeholder="请选择政治面貌">
                            <el-option
                                v-for="(item,index) in zhengzimianmaoTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="政治面貌" prop="zhengzimianmaoValue">
                        <el-input v-model="ruleForm.zhengzimianmaoValue"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhengzimianmao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhengzimianmaoTypesOptions = data.data.list;
                    }
                });
