        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '院系' : ''">
                        <el-select v-model="searchForm.yuanxiTypes" placeholder="请选择院系">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in yuanxiTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '政治面貌' : ''">
                        <el-select v-model="searchForm.zhengzimianmaoTypes" placeholder="请选择政治面貌">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in zhengzimianmaoTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xuejiguanlixitong/upload/yonghuMuBan.xls"
                        >批量导入学生数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="zhengzimianmaoTypes"
                                      header-align="center"
                                      label="政治面貌">
                        <template slot-scope="scope">
                            {{scope.row.zhengzimianmaoValue}}
                        </template>
                    </el-table-column>
