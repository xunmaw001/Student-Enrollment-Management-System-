  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='政治面貌' prop="zhengzimianmaoTypes">
                 <el-select v-model="ruleForm.zhengzimianmaoTypes"  placeholder='请选择政治面貌'>
                     <el-option
...
// 注册表 学生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.zhengzimianmaoTypes)&& 'yonghu'==this.flag){
